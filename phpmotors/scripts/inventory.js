...
function buildInventoryList(data) {
  ...
  let dataTable = "<thead>";
  dataTable += "<tr><th class='vName'>Vehicle Name:</th><td>&nbsp;</td><td>&nbsp;</td></tr>";
  dataTable += "</thead>";
  ...
  data.forEach(function (element) {
    ...
    dataTable += `<td><a class="delete" href='/phpmotors/vehicles?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`;
  });
  dataTable += "</tbody>";
